...
// Private properties
@interface MCPlayerViewController ()
{
    AVPlayer *_player;
    AVURLAsset *_asset;
...
@implementation MCPlayerViewController
...
- (void)viewWillAppear:(BOOL)animated {
    ...
    */
    ...
    MCPlayerViewController __weak *weakSelf = self;
...
- (void)asynchronouslyLoadURLAsset:(AVURLAsset *)newAsset {
    ...
    */
    [newAsset loadValuesAsynchronouslyForKeys:MCPlayerViewController.assetKeysRequiredToPlay completionHandler:^{
